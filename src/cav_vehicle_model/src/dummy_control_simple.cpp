...
int main(int argc, char **argv)
{
    ...
    ros::Publisher ouput_pub = n.advertise<cav_vehicle_model_msgs::VehicleModelInput>("vehicleA/input", 1000);
    ros::Subscriber vehicle_feedback_sub = n.subscribe("vehicleA/output", 1000, feedBackCallback);
