...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
        ...
        if (msg_received)
        {
            ...
            output.vehicle_states.x_6 = atan(tan(x_7) / (2*L));  // rad
            ...
            output.vehicle_states.x_1 = x_1 + dt * output.vehicle_states.x_4 * cos(output.vehicle_states.x_3 + output.vehicle_states.x_6);
            output.vehicle_states.x_2 = x_2 + dt * output.vehicle_states.x_4 * sin(output.vehicle_states.x_3 + output.vehicle_states.x_6);
