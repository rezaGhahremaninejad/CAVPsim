function CodeDefine() { 
this.def = new Array();
this.def["look1_binlcpw"] = {file: "vehicleModel_c.html",line:27,type:"fcn"};
this.def["look1_binlxpw"] = {file: "vehicleModel_c.html",line:82,type:"fcn"};
this.def["vehicleModel.c:rt_ertODEUpdateContinuousStates"] = {file: "vehicleModel_c.html",line:141,type:"fcn"};
this.def["vehicleModel.c:BicycleKinematics_assignModelPr"] = {file: "vehicleModel_c.html",line:219,type:"fcn"};
this.def["vehicleModel.c:vehicleModel_SystemCore_setup"] = {file: "vehicleModel_c.html",line:334,type:"fcn"};
this.def["rt_atan2d_snf"] = {file: "vehicleModel_c.html",line:452,type:"fcn"};
this.def["vehicleModel_step"] = {file: "vehicleModel_c.html",line:489,type:"fcn"};
this.def["vehicleModel_derivatives"] = {file: "vehicleModel_c.html",line:1675,type:"fcn"};
this.def["vehicleModel_initialize"] = {file: "vehicleModel_c.html",line:1708,type:"fcn"};
this.def["vehicleModel_terminate"] = {file: "vehicleModel_c.html",line:1788,type:"fcn"};
this.def["vehicleModel"] = {file: "vehicleModel_c.html",line:1811,type:"fcn"};
this.def["B_vehicleModel_T"] = {file: "vehicleModel_h.html",line:230,type:"type"};
this.def["DW_vehicleModel_T"] = {file: "vehicleModel_h.html",line:236,type:"type"};
this.def["X_vehicleModel_T"] = {file: "vehicleModel_h.html",line:245,type:"type"};
this.def["XDot_vehicleModel_T"] = {file: "vehicleModel_h.html",line:254,type:"type"};
this.def["XDis_vehicleModel_T"] = {file: "vehicleModel_h.html",line:263,type:"type"};
this.def["ODE3_IntgData"] = {file: "vehicleModel_h.html",line:272,type:"type"};
this.def["ExtU_vehicleModel_T"] = {file: "vehicleModel_h.html",line:283,type:"type"};
this.def["ExtY_vehicleModel_T"] = {file: "vehicleModel_h.html",line:292,type:"type"};
this.def["seX5IO8aJqG3LSDcfXTWz2_vehicl_T"] = {file: "vehicleModel_types_h.html",line:42,type:"type"};
this.def["s8wGepGO9yku4SzkM4vzdIG_vehic_T"] = {file: "vehicleModel_types_h.html",line:62,type:"type"};
this.def["so4pBuofLXIy3ixtLNBoZq_vehicl_T"] = {file: "vehicleModel_types_h.html",line:79,type:"type"};
this.def["c_cell_wrap_vehicleModel_T"] = {file: "vehicleModel_types_h.html",line:88,type:"type"};
this.def["d_cell_wrap_vehicleModel_T"] = {file: "vehicleModel_types_h.html",line:97,type:"type"};
this.def["bicycleKinematics_vehicleMode_T"] = {file: "vehicleModel_types_h.html",line:109,type:"type"};
this.def["robotics_slmobile_internal_bl_T"] = {file: "vehicleModel_types_h.html",line:125,type:"type"};
this.def["P_vehicleModel_T"] = {file: "vehicleModel_types_h.html",line:130,type:"type"};
this.def["RT_MODEL_vehicleModel_T"] = {file: "vehicleModel_types_h.html",line:133,type:"type"};
this.def["vehicleModel_P"] = {file: "vehicleModel_data_c.html",line:25,type:"var"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["vehicleModel_c.html"] = "../vehicleModel.c";
	this.html2Root["vehicleModel_c.html"] = "vehicleModel_c.html";
	this.html2SrcPath["vehicleModel_h.html"] = "../vehicleModel.h";
	this.html2Root["vehicleModel_h.html"] = "vehicleModel_h.html";
	this.html2SrcPath["vehicleModel_private_h.html"] = "../vehicleModel_private.h";
	this.html2Root["vehicleModel_private_h.html"] = "vehicleModel_private_h.html";
	this.html2SrcPath["vehicleModel_types_h.html"] = "../vehicleModel_types.h";
	this.html2Root["vehicleModel_types_h.html"] = "vehicleModel_types_h.html";
	this.html2SrcPath["vehicleModel_data_c.html"] = "../vehicleModel_data.c";
	this.html2Root["vehicleModel_data_c.html"] = "vehicleModel_data_c.html";
...
var fileList = [
"vehicleModel_c.html","vehicleModel_h.html","vehicleModel_private_h.html","vehicleModel_types_h.html","vehicleModel_data_c.html","builtin_typeid_types_h.html","multiword_types_h.html","rtGetInf_c.html","rtGetInf_h.html","rtGetNaN_c.html","rtGetNaN_h.html","rt_defines_h.html","rt_nonfinite_c.html","rt_nonfinite_h.html","rtwtypes_h.html","rtmodel_h.html","rt_logging_c.html"];
